...
export class AuthService {
    ...
    async createUserSignup(apiResponse: RequestWithUser): Promise<PrivateProfileDto> {
        let userDto: PrivateProfileDto;
        
        userDto.id = Number(apiResponse.user.id);
        userDto.username = apiResponse.user.username;
        userDto.imagePath = null;
        userDto.error = false;
        userDto.friendList = null;
        userDto.friendRequests = null;
        userDto.matchHistory = null;
        userDto.stats = null;
        userDto.authenticator = false;
    ...
    public async getUserFromSocket(socket: Socket): Promise<PrivateProfileDto | null> {
        ...
        const user : string = await this.authentificateSession(token);
        
        try{
          const userDto: PrivateProfileDto | null = await this.usersService.getProfileEdit(user);
      ...
      async fetchUser(login: any): Promise<PrivateProfileDto>
      {
        ...
        // async signup(apiResponse: any): Promise<PrivateProfileDto> {
        //     const userDto = new PrivateProfileDto();
        
        //     userDto.id = apiResponse.id;
        //     userDto.username = apiResponse.username;
        //     userDto.imagePath = apiResponse.photoUrl;
        //     userDto.error = false;
        //     userDto.friendList = null;
        //     userDto.friendRequests = null;
        //     userDto.matchHistory = null;
        ...
        async clearSession(userDto: PrivateProfileDto) {
