...
export function initAchievement(): Achievement[] {
  return [
    ...
    },
    {
      id: 'UploadImage',
      name: 'Upload image',
      description: 'Change your profile pic',
      achieved: false
    },
    {
      id: 'FirstMessage',
      name: 'First message',
      description: 'Write your first message in the chat',
      achieved: false
    },
    {
      id: 'FirstFriend',
      name: 'First friend',
      description: 'Add someone to your friend list',
      achieved: false
    },
    {
      id: 'ChangeSettings',
    ...
    },
    {
      id: 'WonByGiveUp',
      name: 'Won by give up',
      description: 'Your opponent withdrew from the game',
      achieved: false
    },
    {
      id: 'Wins5',
    ...
    },
    {
      id: 'Shut5',
      name: 'Shut 5 times',
      description: 'Win 5-0 5 times',
      achieved: false
    },
    {
      id: 'Shut10',
      name: 'Shut 10 times',
      description: 'Win 5-0 10 times',
      achieved: false
    },
    {
      id: 'Shut15',
      name: 'Shut 15 times',
      description: 'Win 5-0 15 times',
      achieved: false
    },
    {
      id: 'Shut20',
      name: 'Shut 20 times',
      description: 'Win 5-0 20 times',
      achieved: false
    },
    {
      id: 'Shut25',
      name: 'Shut 25 times',
      description: 'Win 5-0 25 times',
      achieved: false
    },
    {
      id: 'Points25',
