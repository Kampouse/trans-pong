...
const ReactiveCanvas = () => {
	...
	const player1_img = "https://flowbite.com/docs/images/people/profile-picture-1.jpg";
	const player2_img = "https://flowbite.com/docs/images/people/profile-picture-1.jpg";
	...
	return (
		<div className="py-[50px] w-full m-auto max-h-screen overflow-y-scroll scrollbar-hide">
			<div id="container" ref={div} className="m-auto xl:w-[1200px] xl:h-[800px] lg:w-[900px] lg:h-[600px] md:w-[600px] md:h-[400px] sm:w-[600px] sm:h-[400px] w-[300px] h-[200px] pt-[50px]">
				<canvas
						id="myCanvas"
						ref={canvas}
