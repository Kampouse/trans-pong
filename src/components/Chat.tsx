...
export default function Chat(): JSX.Element {
  return (
    ...
    <div className="flex flex-col w-full min-h-screen  sm:h-fit">
      <div className="flex flex-col flex-grow  h-1/2 max-w-xl rounded-2xl w-96 h-96 lg:w-2/6  lg:h-5/6 border-2 border-slate-600 m-10  mt-12  transition ease-in delay-50 shadow-2xl">
        <div className="flex">
          < div className="flex flex-row-reverse w-screen bg-slate-600 rounded-t-lg p-2 text-white">
            <button className="bg-slate-600 rounded-lg p-2 text-white">
        ...
        <div className="flex flex-col  flex-grow h-full p-4 overflow-y-auto">
        ...
        <div className="bg-slate-500 p-4 self-end w-full rounded-b-lg">
          <input
            type="text"
            className="w-full bg-white rounded-b-lg border border-gray-300 focus:outline-none focus:border-blue-500 text-base px-4 py-2"
