...
export function draw (props: DrawProps) {
	...
	if (canvasSize.width === 300) {
		ctx.font = "50px font";
		ctx.fillText(user.score.toString(), canvasSize.width/4 - 10, canvasSize.height/5);
		ctx.fillText(com.score.toString(), 3*canvasSize.width/4 - 10, canvasSize.height/5);
	}
	else {
		ctx.font = "75px font";
		ctx.fillText(user.score.toString(), canvasSize.width/4 - 15, canvasSize.height/5);
		ctx.fillText(com.score.toString(), 3*canvasSize.width/4 - 15, canvasSize.height/5);
	}
...
export function drawGameover(props: DrawProps) {
	...
	if (canvasSize.width === 300) {
		ctx.font = "50px font";
		ctx.fillText(playerWon, (canvasSize.width - 280) / 2, canvasSize.height/2 + 20);
		ctx.fillText(user.score.toString(), canvasSize.width/4 - 10, canvasSize.height/5);
		ctx.fillText(com.score.toString(), 3*canvasSize.width/4 - 10, canvasSize.height/5);
	}
	else {
		ctx.font = "75px font";
		ctx.fillText(playerWon, (canvasSize.width - 415) / 2, canvasSize.height/2 + 20);
		ctx.fillText(user.score.toString(), canvasSize.width/4 - 15, canvasSize.height/5);
		ctx.fillText(com.score.toString(), 3*canvasSize.width/4 - 15, canvasSize.height/5);
	}
