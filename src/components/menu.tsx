...
function ContenterLarge({ children }: { children: React.ReactNode }): JSX.Element {
	return (
		<div className="grid place-items-center w-95 lg:w-1/3 h-96  border border-slate-600 m-9 md:m-14 lg:m-4 shadow-2xl  transition ease-in delay-50 hover:opacity-50">
			{children}
		</div>)
}
